...
// Define LCD pins
#define lcd_data LATD   // Use LATD instead of PORTD
...
far rom const char mycom[] = {0x38,0x0E,0x01,0x06}; // Proper command sequence
far rom const char mydata[] = "LOVE_ABDUL"; 
...
void main() {
    ...
    MSDelay(250); // Initial power-up delay
